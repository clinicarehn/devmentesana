...
$consulta = "SELECT p.nombre AS 'producto', p.concentracion AS 'concentracion', me.nombre AS 'medida', m.cantidad_entrada AS 'entrada', m.cantidad_salida AS 'salida', m.saldo AS 'saldo', m.fecha_registro AS 'fecha_registro', m.comentario AS 'comentario','' AS 'numero'
