...
$comentario = mb_convert_case("Ingreso al Modulo Reporte SMS", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reporte SMS :: <?php echo SERVEREMPRESA;?></title>
...
<div class="container-fluid">
    ...
    <form class="form-inline" id="form_main">
	  ...
	  <div class="form-group mr-1">
         <select id="usuario" name="usuario" class="form-control" data-toggle="tooltip" data-placement="top" title="Colabordor">   				   		 
	  ...
	  <div class="form-group">
		<div class="dropdown show" data-toggle="tooltip" data-placement="top" title="Exportar">
		  ...
		  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
			...
			<a class="dropdown-item" href="#" id="reportes_exportar_diario_colaboradores">Reporte SMS por Colaborador</a>		
		  </div>
		</div>		  
	  </div> 	  
      <div class="form-group">
