...
$comentario = mb_convert_case("Ingreso al Modulo de Atenciones Reporte de Medicas", MB_CASE_TITLE, "UTF-8");   
...
<head>
    ...
    <title>Reporte de Atenciones :: <?php echo SERVEREMPRESA;?></title>
