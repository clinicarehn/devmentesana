    ...
    <form class="form-inline" id="form_main">
      <div class="form-group mx-sm-3 mb-1">
			<div class="input-group">				
				...
				<select id="servicio" name="servicio" class="selectpicker" title="Servicio" data-live-search="true" data-size="7">
				</select>
			</div>
		</div>	
		<div class="form-group mx-sm-3 mb-1">
			<div class="input-group">				
				...
				<select id="reporte" name="reporte" class="selectpicker" title="Reporte" data-live-search="true" data-size="7">
				</select>
			</div>
		</div> 	  
